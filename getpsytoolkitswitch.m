...
Mixed.RT_correct_switch = [taskswitchdata.Var7((idx_switch & idx_correct )&idx_mixed) ...
    ...
    idx_congruent((idx_switch & idx_correct )&idx_mixed) ...
    idx_type((idx_switch & idx_correct )&idx_mixed)];

Mixed.RT_incorrect_switch = [taskswitchdata.Var7((idx_switch & ~idx_correct)&idx_mixed) ...
    idx_hand((idx_switch & ~idx_correct)&idx_mixed) ...
    idx_congruent((idx_switch & ~idx_correct)&idx_mixed) ...
    idx_type((idx_switch & ~idx_correct)&idx_mixed)];

Mixed.RT_correct_noswitch = [taskswitchdata.Var7((~idx_switch & idx_correct)&idx_mixed) ...
    idx_hand((~idx_switch & idx_correct)&idx_mixed) ...
    idx_congruent((~idx_switch & idx_correct)&idx_mixed) ...
    idx_type((~idx_switch & idx_correct)&idx_mixed)];

Mixed.RT_incorrect_noswitch = [taskswitchdata.Var7((~idx_switch & ~idx_correct)&idx_mixed) ...
    idx_hand((~idx_switch & ~idx_correct)&idx_mixed) ...
    idx_congruent((~idx_switch & ~idx_correct)&idx_mixed) ...
    idx_type((~idx_switch & ~idx_correct)&idx_mixed)];
